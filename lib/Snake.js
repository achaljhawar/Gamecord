...
class SnakeGame {
    ...
    async startGame() {
        ...
        let up = new MessageButton().setEmoji(emojis.up ? emojis.up : '⬆️').setStyle('blurple').setID(btn_up)
        let left = new MessageButton().setEmoji(emojis.left ? emojis.left : '⬅️').setStyle('blurple').setID(btn_left)
        let down = new MessageButton().setEmoji(emojis.down ? emojis.down : '⬇️').setStyle('blurple').setID(btn_down)
        let right = new MessageButton().setEmoji(emojis.right ? emojis.right : '➡️').setStyle('blurple').setID(btn_right)
        ...
        let components = [
            ...
            {
              type: 1,  components: [left, down, right, dis3]
            },
        ]
